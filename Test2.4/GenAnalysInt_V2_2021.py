...
def Normal_Test(startFreq, stopFreq, datapoints, BW, num_its, delay, directory, switch1, switch2, freq, power):
...
# TODO Add switch + network analyzer to code
...
"""
def Five_Iteration_Test(startFreq, stopFreq, datapoints, BW, directory, switch1, switch2, power, delay, freq, rpower, i):
...
Init_layout = [
    [sg.Text('All parameters options', font=("Helvetica", 18), pad=(0, 5))],
...
Parameter_layout = [
    ...
    [sg.Cancel(key='_ALLPARAMETERS_CANCEL_', font=("Helvetica", 18), button_text='Return', pad=(0, 0), auto_size_button=True)]]
...
Test_layout = [
    ...
    [sg.Text('Manual inputs - GENERATOR/SWITCH ONLY', font=("Helvetica", 18), pad=(0, 5)),
...
layout = [[sg.Menu(menu_def, tearoff=True)],
          [sg.Frame('Select parameters or test options', Init_layout, font='Any 13', title_color='blue', visible=False,
           ...
           sg.Frame('All parameters options', Parameter_layout, font='Any 13', title_color='blue', visible=False,
                    key='_ALLPARAMETERS_FRAME_', size=(800, 400)),
            ...
            try:
                ...
                for i in range(6):
                    Five_Iteration_Test(value_dict['startfreq'][0], value_dict['stopfreq'][0], value_dict['datapoints'][0],
                                        ...
                                        value_dict['switch2'][0], value_dict['itpower'][i - 1], value_dict['itdpower'][i - 1], value_dict['freq1'][0],
