...
# ------Create Definition ------ #
create_layout = [
    [sg.Text('Generator + switch test', font=("Helvetica", 18), pad=(0, 5)),
...
window = sg.Window('GENERATOR + SWITCH TEST - V1 - IARC', layout, default_element_size=(40, 1), grab_anywhere=False,
                   size=(800, 400))
