...
AUTOMATION CONTROL CODE - NETWORK ANALYZER WITH SWITCH, GENERATOR and PUMPS (Peristaltic and isocratic) - V1 - 2021
...
"""
def Normal_Test(startFreq, stopFreq, datapoints, BW, num_its, delay, directory, switch1, switch2, freq, power, Peris_ON, RPM, Iso_ON):
    ...
    if Iso_ON == 1:
        ...
        print("Isocratic pump turned OFF\n")
...
"""
def Five_Iteration_Test(startFreq, stopFreq, datapoints, BW, directory, switch1, switch2, power, delay, freq, rpower, i, Peris_ON, RPM, Iso_ON):
...
Parameter_layout = [
    ...
    [sg.Text('Pumps (FOR NORMAL AND FIVE ITERATION TEST)', font=("Helvetica", 12), pad=(0, 5))],
...
Test_layout = [
    ...
    [sg.Text('Manual pumps (IN DEVELOPMENT)', font=("Helvetica", 18), pad=(0, 5)),
     sg.Submit(key='_TEST_OK5_', button_text='OK', font=("Helvetica", 18), pad=(40, 10))],
...
window = sg.Window('ANALYZER + GENERATOR + SWITCH + PUMPS - IARC - V1', layout, default_element_size=(40, 1), grab_anywhere=False,
                   size=(1200, 600))


# Print introductory message
print("\n\n------------------WELCOME TO THE TEST 2.6/2.7 UI! Select OPTIONS -> TEST to get started.------------------\n")
            ...
            try:
                ...
                for i in range(6):
                    Five_Iteration_Test(value_dict['startfreq'][0], value_dict['stopfreq'][0], value_dict['datapoints'][0],
                                        ...
                                        value_dict['rpower1'][0], i + 1, Peris_ON, value_dict['RPM'][0], Iso_ON)
                    if i >= 1:
