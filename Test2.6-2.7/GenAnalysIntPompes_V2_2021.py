...
AUTOMATION CONTROL CODE - NETWORK ANALYZER WITH SWITCH, GENERATOR and PUMPS (Peristaltic and isocratic) - V2 - 2021
...
def Freq_sweep(startFreq, stopFreq, datapoints, BW, directory, powersweep, ONdelay, OFFdelay, startfreq, stopfreq,
    ...
    if IsManu:
        ...
        num_its = int(((stopFreq - startFreq) / stepfreq) + 2)
...
# PUMPS ONLY
def Manual_Pumps(Manu_Pumps_State, RPM):
...
def Five_Iteration_Test(startFreq, stopFreq, datapoints, BW, directory, switch1, switch2, power, ONdelay, OFFdelay,
    ...
    if i == 1:
        ...
        if i == 6:
            ...
            sg.OneLineProgressMeter('Test progress...', 2 * num_its + 3, 2 * num_its + 4, key='METER1',
                                    grab_anywhere=True)
...
Init_layout = [
    [sg.Text('Test parameter configurations', font=("Helvetica", 18), pad=(0, 5))],
    [sg.Submit(key='_ALLPARAMETERS_OK_', button_text='Select', font=("Helvetica", 18), pad=(0, 20))],
    [sg.Text('Functions', font=("Helvetica", 18), pad=(0, 5)), ],
    [sg.Submit(key='_TEST_OK_', font=("Helvetica", 18), button_text='Select', pad=(0, 20),
               auto_size_button=True)]]

Parameter_layout = [
    [sg.Text('Network Analyzer (FOR ALL TESTS)', font=("Helvetica", 12), pad=(0, 5))],
    [sg.Submit(key='_ANA_OK_', button_text='Select', font=("Helvetica", 12), pad=(20, 20))],
    [sg.Text('Switch (FOR ALL FUNCTIONS)', font=("Helvetica", 12), pad=(0, 5))],
    ...
    [sg.Text('Pumps (FOR ALL TESTS)', font=("Helvetica", 12), pad=(0, 5))],
...
Test_layout = [
    ...
    [sg.Text('Sweep test - SELECT MANUAL ONLY', font=("Helvetica", 14), pad=(0, 5)),
    ...
    [sg.Text('Pumps (Iso and Peris)', font=("Helvetica", 14), pad=(0, 5)),
...
gen_layout = [
    ...
    [sg.Text('ON delay duration (s)', font=("Helvetica", 18)),
     sg.Input('', do_not_clear=True, key='_ONDELAY1_', size=(10, 10), font=("Helvetica", 18))],
    [sg.Text('OFF delay duration (s)', font=("Helvetica", 18)),
...
Peristaltic_layout = [
    ...
    [sg.Radio('ISO ON', "RADIO3", default=False, change_submits=True, key="_ISO_ON_", font=("Helvetica", 18),
              size=(10, 1), pad=(100, 10)),
     sg.Radio('ISO OFF', "RADIO3", default=False, change_submits=True, key="_ISO_OFF_",
              font=("Helvetica", 18), size=(10, 1), pad=(100, 10))],
...
sweep_layout = [
    [sg.Text('Microwave power (W)', font=("Helvetica", 18)),
     sg.Input('', do_not_clear=True, key='_POWER2_', size=(10, 10), font=("Helvetica", 18))],
    [sg.Text('Microwaves ON Delay (s): ', font=("Helvetica", 18)),
     sg.Input('', do_not_clear=True, key='_ONDELAY2_', size=(10, 10), font=("Helvetica", 18)),
     sg.Text('Microwaves OFF Delay (s): ', font=("Helvetica", 18)),
     sg.Input('', do_not_clear=True, key='_OFFDELAY2_', size=(10, 10), font=("Helvetica", 18))],
...
manu_pumps_layout = [
    [sg.Text('Peristaltic flow speed (RPM)', font=("Helvetica", 18)),
     sg.Input('', do_not_clear=True, key='_RPM1_', size=(10, 10), font=("Helvetica", 18))],
    [sg.Radio('PERIS ON', "RADIO4", default=False, change_submits=True, key="_MANU_PERIS_ON_", font=("Helvetica", 18),
              size=(10, 1), pad=(100, 10)),
     sg.Radio('PERIS OFF', "RADIO4", default=False, change_submits=True, key="_MANU_PERIS_OFF_",
              font=("Helvetica", 18), size=(10, 1), pad=(100, 10))],
    [sg.Radio('ISO ON', "RADIO4", default=False, change_submits=True, key="_MANU_ISO_ON_", font=("Helvetica", 18),
              size=(10, 1), pad=(100, 10)),
     sg.Radio('ISO OFF', "RADIO4", default=False, change_submits=True, key="_MANU_ISO_OFF_",
              font=("Helvetica", 18), size=(10, 1), pad=(100, 10))],
...
layout = [[sg.Menu(menu_def, tearoff=True)],
          [sg.Frame('Select parameters or functions', Init_layout, font='Any 13', title_color='blue', visible=False,
                    key='_INIT_FRAME_', size=(800, 400)),
           sg.Frame('Test parameters options', Parameter_layout, font='Any 13', title_color='blue', visible=False,
                    key='_ALLPARAMETERS_FRAME_', size=(1200, 600)),
           sg.Frame('Generator test options', gen_layout, font='Any 13', title_color='blue', visible=False,
                    key='_GEN_FRAME_', size=(800, 300)),
           sg.Frame('ENA test options', Analyzer_layout, font='Any 13', title_color='blue', visible=False,
                    key='_ANA_FRAME_', size=(800, 400)),
           sg.Frame('ENA test parameter options 1', Freq_layout, font='Any 13', title_color='blue', visible=False,
                    key='_FREQ_FRAME_', size=(800, 400)),
           sg.Frame('ENA parameter test options 2', Params1_layout, font='Any 13', title_color='blue', visible=False,
                    key='_PARAMS1_FRAME_', size=(800, 400)),
           sg.Frame('Switch test options', Switch_layout, font='Any 13', title_color='blue', visible=False,
                    key='_SWITCH_FRAME_', size=(800, 400)),
           sg.Frame('Switch test parameter options', Params2_layout, font='Any 13', title_color='blue', visible=False,
                    key='_PARAMS2_FRAME_', size=(800, 400)),
           sg.Frame('Pumps test options', Peristaltic_layout, font='Any 13', title_color='blue', visible=False,
                    key='_PUMPS_FRAME_', size=(800, 400)),
           sg.Frame('Functions options', Test_layout, font='Any 13', title_color='blue', visible=False,
...
window = sg.Window('AUTOMATION CIRCUIT - V1', layout, default_element_size=(40, 1), grab_anywhere=False,
                   size=(1200, 600))

# Print introductory message
print("\n\n------------------WELCOME TO THE AUTOMATION CIRCUIT V1 UI! Select OPTIONS -> TEST to get started.------------------\n")
...
def main():
    value_dict = {"startfreq": [], "stopfreq": [], "datapoints": [], "bw": [], "num_its": [], "ondelay1": [],
                  ...
                  "startfreq2": [], "stopfreq2": [], "ondelay2": [], "offdelay2": [], "stepfreq": [], "power3": [],
                  "rpower": [], "itpower": [],
                  "ondelay3": [], "offdelay3": [], "freq2": [], "startfreqmanu": [], "stopfreqmanu": [],
    ...
    while True:
        ...
        if event == '_TEST2_OK_':
            try:
                ...
                Freq_sweep(value_dict['startfreq'][0], value_dict['stopfreq'][0], value_dict['datapoints'][0],
                           value_dict['bw'][0], value_dict['directory'][0], value_dict['power2'][0],
                           value_dict['ondelay2'][0], value_dict['offdelay2'][0],
        ...
        if event == '_TEST4_OK_':
            ...
            try:
                ...
                Manual_Pumps(Manu_Pumps_State, value_dict['RPM1'][0])
            ...
            try:
                ...
                for i in range(6):
                    Five_Iteration_Test(value_dict['startfreq'][0], value_dict['stopfreq'][0],
                                        ...
                                        value_dict['freq2'][0], value_dict['rpower1'][0], i + 1, Peris_ON,
        ...
        if event == '_LAUNCH_OK_':
            try:
                ...
                Normal_Test(value_dict['startfreq'][0], value_dict['stopfreq'][0], value_dict['datapoints'][0],
                            ...
                            value_dict['freq1'][0], value_dict['power1'][0], Peris_ON, value_dict['RPM'][0], Iso_ON)
                sg.popup("Test is complete!")
                window.FindElement('_TEST_FRAME_').Update(visible=True)
                window.FindElement('_NORMALTEXT_FRAME_').Update(visible=True)
                # window.reappear()
        ...
        if event == '_CONFIG4_OK_':
            ...
            try:
                ...
                value_dict["ondelay2"].append(float(values['_ONDELAY2_']))
                value_dict["offdelay2"].append(float(values['_OFFDELAY2_']))
