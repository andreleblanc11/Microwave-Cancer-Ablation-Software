...
AUTOMATION CONTROL CODE - FULL CONTROL - V4 - 2021 - NO SWITCH
    ...
    if i == 1:
        ...
        if Flow != -1:
            ...
            while TempsTot < float(ONdelay - (delaimesure + delaimicro)):
                ...
                # Sortir de la boucle si la puissance transmise actuelle n'est pas mesurer a une valeur de 0
                if rr2[0] != 0:
...
def Excel_Data_Format(DonneesTemps, rpowergraph, powergraph, ecart_type_reel, ecart_type_im, directory):
    ...
    for k in range(len(DonneesTemps)):
        ...
        sheet_ranges.cell(row=14+k, column=3).value = int(reel[k])
...
def main():
    ...
    print("\n\n------------------WELCOME TO THE AUTOMATION CIRCUIT V4 UI! Select OPTIONS -> CREATE to get started.------------------\n")
