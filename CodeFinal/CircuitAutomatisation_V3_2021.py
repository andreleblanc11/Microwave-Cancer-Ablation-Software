...
AUTOMATION CONTROL CODE - FULL CONTROL - V3 - 2021
...
client = ModbusClient(method='rtu', port='COM3', timeout=4, baudrate=115200, strict=False)
...
def Five_Iteration_Test(startFreq, stopFreq, datapoints, BW, directory, delaimicro, delaimesure, switch1, switch2, power, ONdelay, Flow,
    ...
    if i == 1:
        ...
        TextFile = open("C:/Users\DELL-MW-03\OneDrive - Université de Moncton\Desktop\Ablation_Automatisation\Programmation\Automatisation_Andre\Logs/" + str(LogFileName) + ".txt", "w")
        ...
        if Flow != -1:
            ...
            # Créer et ouvrir fichier text pour sauvegarder le log des opérations
            TextFile = open("C:/Users\DELL-MW-03\OneDrive - Université de Moncton\Desktop\Ablation_Automatisation\Programmation\Automatisation_Andre\Logs/" + str(LogFileName) + ".txt", "a")
...
def S_Averages(directory, datapoints, DonneesTemps, ecart_type_reel, ecart_type_im):
    ...
    for j in range(len(DonneesTemps)):
        ...
        S1PFile = open("C:/Users\DELL-MW-03\OneDrive - Université de Moncton\Desktop\Ablation_Automatisation\Programmation\Automatisation_Andre\Donnees\\" + directory + "/Iteration_" + str(j + 1) + ".s1p", "r")
        ...
        if j != 0:
            ...
            AppendFile = open("C:/Users\DELL-MW-03\OneDrive - Université de Moncton\Desktop\Ablation_Automatisation\Programmation\Automatisation_Andre\DonneesMoyennes\DonneesMoyennes.s1p", "a")
            AppendFile.write(str(av1_corr) + " " + str(av2_corr) + " " + str(av3_corr) + " " + "\n")

        else:
            NewFile = open("C:/Users\DELL-MW-03\OneDrive - Université de Moncton\Desktop\Ablation_Automatisation\Programmation\Automatisation_Andre\DonneesMoyennes\DonneesMoyennes.s1p", "w")
...
def Excel_Data_Format(DonneesTemps, rpowergraph, powergraph, ecart_type_reel, ecart_type_im):
    ...
    wb = openpyxl.load_workbook(filename='C:/Users\DELL-MW-03\OneDrive - Université de Moncton\Desktop\Ablation_Automatisation\Programmation\Automatisation_Andre\DonneesMoyennes\DonneesMoyennes.xlsx')
    sheet_ranges = wb['DonneesMoyennes']
    ...
    sheet_ranges.cell(row=13, column=4).value = 'Temps (s)'
    ...
    for k in range(len(DonneesTemps)):
        sheet_ranges.cell(row=14+k, column=4).value = float(TempsExcel[k])
        ...
        sheet_ranges.cell(row=14+k, column=9).value = float(ecart_type_reel[k] * reel[k])
        sheet_ranges.cell(row=13+k, column=8).value = float(ecart_type_im[k] * im[k])

    wb.save(filename='C:/Users\DELL-MW-03\OneDrive - Université de Moncton\Desktop\Ablation_Automatisation\Programmation\Automatisation_Andre\DonneesMoyennes\DonneesMoyennes.xlsx')
...
Init_layout = [
    ...
    [sg.Image(
        'C:/Users\DELL-MW-03\OneDrive - Université de Moncton\Desktop\Ablation_Automatisation\Programmation\Images\IARC_LOGO.png',
        pad=(100, 0)),
     sg.Image(
         'C:/Users\DELL-MW-03\OneDrive - Université de Moncton\Desktop\Ablation_Automatisation\Programmation\Images\LOGO_UdeM.png',
         pad=(100, 0))],
...
Parameter_layout = [
    ...
    [sg.Image(
        'C:/Users\DELL-MW-03\OneDrive - Université de Moncton\Desktop\Ablation_Automatisation\Programmation\Images\ENA.png',
        pad=(50, 5)),
     sg.Image(
         'C:/Users\DELL-MW-03\OneDrive - Université de Moncton\Desktop\Ablation_Automatisation\Programmation\Images\Switch.png',
         pad=(250, 5))],
    ...
    [sg.Text('Generator and Delays (ALL TESTS)', font=("Helvetica", 12), pad=(0, 5)),
     sg.Text('                                                        Pumps (ALL TESTS)', font=("Helvetica", 12),
             pad=(0, 5))],
    [sg.Image(
        'C:/Users\DELL-MW-03\OneDrive - Université de Moncton\Desktop\Ablation_Automatisation\Programmation\Images\Generatrice.png',
        pad=(50, 5)),
     sg.Text('', font=("Helvetica", 12), pad=(75, 5)),
     sg.Image(
         'C:/Users\DELL-MW-03\OneDrive - Université de Moncton\Desktop\Ablation_Automatisation\Programmation\Images\IsoPump.png',
         pad=(0, 5)),
     sg.Image(
         'C:/Users\DELL-MW-03\OneDrive - Université de Moncton\Desktop\Ablation_Automatisation\Programmation\Images\PerisPump.png',
         pad=(0, 5))],
...
Params2_layout = [
    ...
    [sg.Text('Relay PCB: ', font=("Helvetica", 18)),
     sg.Image(
         'C:/Users\DELL-MW-03\OneDrive - Université de Moncton\Desktop\Ablation_Automatisation\Programmation\Images\Relais.png',
         pad=(25, 5))],
    [sg.Text('', font=("Helvetica", 18))],
...
five_it_layout = [
    ...
    [sg.Text('Délai premier état (Micro Onde ON)', font=("Helvetica", 18)),
     sg.Input('', do_not_clear=True, key='_DELAIMICRO_', size=(10, 10), font=("Helvetica", 18)),
     sg.Text('Délai deuxième état (Mesure diélectrique)', font=("Helvetica", 18)),
     sg.Input('', do_not_clear=True, key='_DELAIMESURE_', size=(10, 10), font=("Helvetica", 18))],
...
def main():
    ...
    while True:
        ...
        if event == '_EXCELDATA_':
            # try:
            Excel_Data_Format(value_dict['donneestemps'], value_dict['rpowergraph'], value_dict['powergraph'], value_dict['stdevreel'],value_dict['stdevim'])
