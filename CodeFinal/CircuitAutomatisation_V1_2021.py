...
AUTOMATION CONTROL CODE - FULL CONTROL - V1 - 2021
...
def Freq_sweep(datapoints, BW, directory, powersweep, rpower, ONdelay, OFFdelay, startfreq, stopfreq,
    ...
    if IsManu:
        ...
        while currentfreqKHz <= stopfreqKHz:
            ...
            sg.OneLineProgressMeter('Test progress...', 2 * (count + 1) + 2, 2 * num_its + 4, key='METER1', grab_anywhere=True)
            ...
            # TAKE MEASUREMENT AND SAVE FILE OF PORT 1 AS A .S1P (REAL IMAGINARY DATA FORMAT)
            analyzer.write("CALC:MEAS:DATA:SNP:PORTs:Save '1,,', '" + filename + "/Iteration" + str(count + 1) + ".s1p'")
            analyzer.write("*OPC?")
...
def Five_Iteration_Test(startFreq, stopFreq, datapoints, BW, directory, switch1, switch2, power, ONdelay, OFFdelay,
                        freq, rpower, i, Peris_ON, RPM, Iso_ON, IsLog):
    ...
    if i == 1:
        ...
        analyzer.write("TRIGger:SCOPe CURRent")
        analyzer.write("INITiate1:IMMediate")
        # analyzer.write("MMEMory:STORe:DATA '" + filename + "/Iteration" + str(i - 1) + ".csv', 'CSV formatted Data','Trace','RI', 1")

        # DELAY OF INPUT VALUE SECONDS WITH CORRECTION
        time.sleep(OFFdelay)

        # TAKE MEASUREMENT AND SAVE FILE OF PORT 1 AS A .S1P (REAL IMAGINARY DATA FORMAT)
        analyzer.write("CALC:MEAS:DATA:SNP:PORTs:Save '1,,', '" + filename + "/Iteration" + str(i - 1) + ".s1p'")
        analyzer.write("*OPC?")
...
Init_layout = [
    ...
    [sg.Image('C:/Users\shark\OneDrive - Université de Moncton\Desktop\Genie\Ge_21\Stage3\IARC\Travaux\Realisation\Programmation\Images\IARC_LOGO.png', pad=(100, 0)),
     sg.Image('C:/Users\shark\OneDrive - Université de Moncton\Desktop\Genie\Ge_21\Stage3\IARC\Travaux\Realisation\Programmation\Images\LOGO_UdeM.png', pad=(100, 0))],
...
Parameter_layout = [
    ...
    [sg.Image('C:/Users\shark\OneDrive - Université de Moncton\Desktop\Genie\Ge_21\Stage3\IARC\Travaux\Realisation\Programmation\Images\ENA.png', pad=(50, 5)),
     sg.Image('C:/Users\shark\OneDrive - Université de Moncton\Desktop\Genie\Ge_21\Stage3\IARC\Travaux\Realisation\Programmation\Images\Switch.png', pad=(250, 5))],
    ...
    [sg.Image('C:/Users\shark\OneDrive - Université de Moncton\Desktop\Genie\Ge_21\Stage3\IARC\Travaux\Realisation\Programmation\Images\Generatrice.png', pad=(50, 5)),
     sg.Text('', font=("Helvetica", 12), pad=(75, 5)),
     sg.Image('C:/Users\shark\OneDrive - Université de Moncton\Desktop\Genie\Ge_21\Stage3\IARC\Travaux\Realisation\Programmation\Images\IsoPump.png', pad=(0, 5)),
     sg.Image('C:/Users\shark\OneDrive - Université de Moncton\Desktop\Genie\Ge_21\Stage3\IARC\Travaux\Realisation\Programmation\Images\PerisPump.png', pad=(0, 5))],
...
Test_layout = [
    ...
    [sg.Text('                                                            Normal test', font=("Helvetica", 14), pad=(20, 5)),
    ...
    [sg.Text('                                                            Generator', font=("Helvetica", 14), pad=(20, 5)),
...
gen_layout = [
    ...
    [sg.Text('Reflected power (W, set to 0 for automatic configuration)', font=("Helvetica", 18), text_color='red', background_color='yellow'),
...
Analyzer_layout = [
    [sg.Text('Frequencies, datapoints, input power & sweep mode', font=("Helvetica", 18), pad=(0, 5)), ],
...
Peristaltic_layout = [
    ...
    [sg.Image('C:/Users\shark\OneDrive - Université de Moncton\Desktop\Genie\Ge_21\Stage3\IARC\Travaux\Realisation\Programmation\Images\PerisPump.png', pad=(50, 10))],
    ...
    [sg.Image('C:/Users\shark\OneDrive - Université de Moncton\Desktop\Genie\Ge_21\Stage3\IARC\Travaux\Realisation\Programmation\Images\IsoPump.png', pad=(50, 10))],
...
sweep_layout = [
    [sg.Text("Description: For this test, the ENA and the generators' frequencies are adjusted at each iteration", font=("Helvetica", 18))],
...
manu_gen_layout = [
    ...
    [sg.Image('C:/Users\shark\OneDrive - Université de Moncton\Desktop\Genie\Ge_21\Stage3\IARC\Travaux\Realisation\Programmation\Images\Generatrice.png', pad=(10, 0))],
    [sg.Text('', font=("Helvetica", 18))],
    [sg.Submit(key='_RESET_FAULTS_', font=("Helvetica", 18), button_text='RESET GENERATOR FAULTS', pad=(250, 20), auto_size_button=True)],
...
manu_ENA_layout = [
    ...
    [sg.Submit(key='_CONFIG6_OK_', font=("Helvetica", 18), button_text='Set values', pad=(100, 10),
     ...
     sg.Submit(key='_TEST3_OK_', font=("Helvetica", 18), button_text='Trigger ENA', pad=(100, 10),
               auto_size_button=True)],
    [sg.Image('C:/Users\shark\OneDrive - Université de Moncton\Desktop\Genie\Ge_21\Stage3\IARC\Travaux\Realisation\Programmation\Images\ENA.png', pad=(250, 0))],
...
manu_pumps_layout = [
    ...
    [sg.Radio('COOLING ON', "RADIO4", default=False, change_submits=True, key="_MANU_PERIS_ON_", font=("Helvetica", 18),
     ...
     sg.Radio('COOLING OFF', "RADIO4", default=False, change_submits=True, key="_MANU_PERIS_OFF_",
              font=("Helvetica", 18), size=(15, 1), pad=(50, 10))],
    [sg.Image('C:/Users\shark\OneDrive - Université de Moncton\Desktop\Genie\Ge_21\Stage3\IARC\Travaux\Realisation\Programmation\Images\PerisPump.png', pad=(50, 0))],
    [sg.Radio('ALCOHOL ON', "RADIO4", default=False, change_submits=True, key="_MANU_ISO_ON_", font=("Helvetica", 18),
     ...
     sg.Radio('ALCOHOL OFF', "RADIO4", default=False, change_submits=True, key="_MANU_ISO_OFF_",
              font=("Helvetica", 18), size=(15, 1), pad=(50, 10))],
    [sg.Image('C:/Users\shark\OneDrive - Université de Moncton\Desktop\Genie\Ge_21\Stage3\IARC\Travaux\Realisation\Programmation\Images\IsoPump.png', pad=(50, 0))],
...
five_it_layout = [
    [sg.Text('Description: For this test, the power and delay durations can be changed at each iteration.', font=("Helvetica", 18))],
    [sg.Text("", font=("Helvetica", 10))],
...
window = sg.Window('AUTOMATION CIRCUIT - V3', layout, default_element_size=(40, 1), grab_anywhere=False,
                   size=(1200, 700))
...
def main():
    value_dict = {"startfreq": [], "stopfreq": [], "datapoints": [], "bw": [], "num_its": [], "ondelay1": [],
                  ...
                  "delayENAmanu": [], "directorymanu": [], "RPM": [], "RPM1": [], "inputpower": []}
    ...
    while True:
        ...
        if event == '_TEST2_OK_':
            try:
                ...
                Freq_sweep(value_dict['datapoints'][0],
                           ...
                           value_dict['switch1'][0], value_dict['switch2'][0], Peris_ON, value_dict['RPM'][0], Iso_ON, IsLog)
        ...
        if event == '_CONFIG5_OK_':
            ...
            try:
                ...
                # Clause de sécurité. Prévenir l'utilisateur que les valeurs de puissance configurés requis l'accompagnement de la pompe à refroidisement.
                if (20 <= value_dict["itpower"][0] < 200) or (20 <= value_dict["itpower"][1] < 200) or (20 <= value_dict["itpower"][2] < 200) or (20 <= value_dict["itpower"][3] < 200) or (20 <= value_dict["itpower"][4] < 200):
                    sg.popup("For the values of transmitted power you've selected, cooling might/will be required.\nPress OK to continue.")

                # Clause de sécurité. Prévenir à ce que l'utilisateur choisisse une valeur de puissance au-delà de 200 W.
                if value_dict["itpower"][0] >= 200 or value_dict["itpower"][1] >= 200 or value_dict["itpower"][2] >= 200 or value_dict["itpower"][3] >= 200 or value_dict["itpower"][4] >= 200:
